...
public class GeofenceTransitionsIntentService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
			...
			sendNotification(getString(R.string.app_name),getString(R.string.geofence_transition_notification_text_enter));
			...
			// Send notification and log the transition details.
			sendNotification(getString(R.string.app_name),getString(R.string.geofence_transition_notification_text_exit));
			// sendNotification(getString(R.string.app_name));
			Log.i(TAG, geofenceTransitionDetails);
		} else {
			// Log the error.
