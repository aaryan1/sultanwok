...
public class ShippingBillingFragment extends DialogFragment {
	...
	private EditText streetEdt, zipCodeEdt;// , phoneEdt;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setStyle(STYLE_NO_TITLE, R.style.CustomDialog1);
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		zipCodeEdt = (EditText) view.findViewById(R.id.zipCode);
		...
		localityTxt = (TextView) view.findViewById(R.id.locality1);
		stateTextView = (TextView) view.findViewById(R.id.states1);
		statesEdt = (AutoCompleteTextView) view.findViewById(R.id.statesAuto);
...
//			
		...
		protected String doInBackground(String... params) {
			// TODO Auto-generated method stub
			if (isBilling) {
				return JsonParser.Webserice_Call_URL1(ConstantsUrl.GETCITIES
						+ params[0], null, null);
			} else {
